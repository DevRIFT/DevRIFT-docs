...
<div class="flex flex-col shrink gap-6 px-12 py-8">
    ...
    <p class="text-xl font-bold">Test Environments</p>

    <p class="text-gray-500">
        By using a Secret Test Key and a Publisher Test Key, you are given an environment to test inside of.
    </p>

    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4" role="alert">
        <p class="font-bold">Warning</p>
        <p>Test environments cannot be used to test some features, these include: MFA via SMS, Dual MFA, and HALT</p>
    </div>

    <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4" role="info">
        <p class="font-bold">Information</p>
        <p>When you no longer need a Test Environment, you can disable the Test Keys in the Application Settings.</p>
    </div>
    ...
    <a class="inline-flex items-center rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring active:text-indigo-500"
        href="https://docs.devrift.co/going-live">
        <span class="text-sm font-medium"> Next: Going Live </span>
