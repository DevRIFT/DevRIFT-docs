...
<div class="flex flex-col shrink gap-6 px-12 py-8">
    ...
    <p class="text-xl font-bold">API Versioning</p>

    <p class="text-gray-500">
        When we make irreversible, non-backwards compatible changes to the API, we will increment the version number. 
        <br>
        You can change the API Version your application uses by changing the API Version Number in your Application Settings.
    </p>

    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4" role="alert">
        <p class="font-bold">Warning</p>
        <p>
            Make sure you are using the right version number. Using the wrong version number may result in your application not working.
        </p>
    </div>

    <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4" role="info">
        <p class="font-bold">Information</p>
        <p>The latest API Version is 12.12.22</p>
    </div>
    ...
    <a class="inline-flex items-center rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring active:text-indigo-500"
        href="https://docs.devrift.co/authentication/activation-mail">
        <span class="text-sm font-medium"> Next: Authentication | Activation Emails </span>
