...
<div class="flex flex-col shrink gap-6 px-12 py-8">
    ...
    <div>
        <p class="text-xl font-bold inline-flex">DevRIFT Logging&nbsp;</p>

        <span
            class="inline-flex items-center justify-center rounded-full bg-gradient-to-r via-purple-100 from-pink-100 to-amber-100 px-2.5 py-0.5 text-purple-700">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="-ml-1 mr-1.5 h-4 w-4">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    ...
    <div class="bg-gradient-to-r via-purple-100 from-pink-100 to-amber-100 border-l-4 border-purple-500 text-purple-700 p-4" role="feature">
        ...
        <p>
            DevRIFT Logging is still in development, no Documentation is available yet.
        </p>
    </div>
    ...
    <a class="inline-flex items-center rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring active:text-indigo-500"
        href="https://docs.devrift.co/">
        <span class="text-sm font-medium"> Docs Homepage </span>
