...
<div class="flex flex-col shrink gap-6 px-12 py-8">
    ...
    <div>
        <p class="text-xl font-bold inline-flex">Activation Emails&nbsp;</p>
    ...
    <p class="text-gray-500">
        ...
        <br>
        You can change the API Version your application uses by changing the API Version Number in your Application
        Settings.
    </p>
    ...
    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4" role="alert">
        ...
        <p>
            Make sure you are using the right version number. Using the wrong version number may result in your
    ...
    <a class="inline-flex items-center rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring active:text-indigo-500"
        href="https://docs.devrift.co/authentication/mfa">
        <span class="text-sm font-medium"> Next: Authentication | Multi Factor Authentication (MFA)</span>
