...
<div class="flex flex-col shrink gap-6 px-12 py-8">
    ...
    <div>
        <p class="text-xl font-bold inline-flex">Dual Multi Factor Authentication&nbsp;</p>
    ...
    <p class="text-gray-500">
        You can implement Dual Multi Factor Authentication (DMFA) via Emails using the DevRIFT API. This is a paid feature, only
        available on premium and enterprise plans.
    </p>

    <div class="bg-gradient-to-r via-purple-100 from-pink-100 to-amber-100 border-l-4 border-purple-500 text-purple-700 p-4" role="feature">
        <p class="font-bold">New Feature</p>
        <p>
            Dual MFA is a new feature that sends a one of your Users both an Email and a SMS with an MFA Code.
        </p>
    </div>
    ...
    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4" role="alert">
        ...
        <p>
            You should use a Test Environment to start the Dual MFA Integration Process.
        </p>
    </div>
    ...
    <p class="text-gray-500">
        Example Code to send a Dual MFA Request:
    </p>
    ...
    <code class="block text-gray-500 bg-gray-100 px-2 whitespace-pre-wrap rounded">
		...
		&nbsp;
		// Sending a Dual MFA Request
        \DevRIFT\DevRIFT::sendMFAEmail(YOUR_USERS_EMAIL, YOUR_USERS_PHONE_NUMBER);
		&nbsp;
        /*
        What this does:
        - This will send a POST request to https://api.devrift.co/
        - The request will contain your Publisher Key and Secret Key
        - The API will send an MFA Code to the email address and phone number provided
        */
        &nbsp;
	</code>
    ...
    <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4" role="info">
        ...
        <p>
            The same MFA Code will be sent to both the Email and Phone Number
        </p>
    </div>
    ...
    <a class="inline-flex items-center rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring active:text-indigo-500"
        href="https://docs.devrift.co/authentication/custom-mfa">
        <span class="text-sm font-medium"> Next: Authentication | Custom MFA</span>
