...
<div class="flex flex-col shrink gap-6 px-12 py-8">
    ...
    <div>
        <p class="text-xl font-bold inline-flex">Security Key Integration (HSM)&nbsp;</p>
    ...
    <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4" role="info">
        ...
        <p>
            This service is free. However there are limits to what you can do, you should consider reading the Terms of Service <a href="https://legal.devrift.co/terms" class="text-blue-700 underline">here</a>.
            <br>
            We allow HSM as another means to authenticate your users.
        </p>
    </div>

    <p class="text-gray-500">
        Hardware Security Modules (HSM) are devices that are used to store cryptographic keys and perform cryptographic operations.
        <br>
        You can use the DevRIFT API to integrate HSM easily for your users.
    </p>

    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4" role="alert">
        <p class="font-bold">Warning</p>
        <p>
            HSM Integration is not currently available, hence we have not displayed any API Documentation.
        </p>
    </div>
    ...
    <a class="inline-flex items-center rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring active:text-indigo-500"
        href="https://docs.devrift.co/authentication/sms">
        <span class="text-sm font-medium"> Next: Authentication | SMS with MFA</span>
