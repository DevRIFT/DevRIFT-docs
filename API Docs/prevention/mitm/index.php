...
<div class="flex flex-col shrink gap-6 px-12 py-8">
    ...
    <div>
        <p class="text-xl font-bold inline-flex">Man-in-the-Middle Attack Prevention&nbsp;</p>
    ...
    <p class="text-gray-500">
        A Man-in-the-Middle attack is when an attacker intercepts a connection between two parties and
        impersonates one of them. This can be used to steal information or impersonate a user.
        <br>
        We use Digital Signatures (DS) to prevent this from happening.
    </p>

    <p class="text-xl font-bold inline-flex">Setting up MITM Prevention&nbsp;</p>

    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4" role="info">
        <p class="font-bold">Coming Soon</p>
        <p>
            We haven't released this feature yet, but we're working on it!
        </p>
    </div>

    <code class="block text-gray-500 bg-gray-100 px-2 whitespace-pre-wrap rounded">
		// Inculding DevRIFT JavaScript SDK
        &lt;script src="https://js.devrift.co"&gt;&lt;/script&gt;		
		&nbsp;
	</code>

    <p class="text-xl font-bold inline-flex">Verifying a Digital Signature&nbsp;</p>

    <p class="text-gray-500">
        You can verify a digital signature by adding the following code to the top of every script that takes user
        input:
    </p>
    ...
    <code class="block text-gray-500 bg-gray-100 px-2 whitespace-pre-wrap rounded">
		...
		&nbsp;
		// Running DS Check [INCOMPLETE]
        \DevRIFT\DevRIFT::verifySignature();
		&nbsp;
	</code>
    ...
    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4" role="info">
        ...
        <p>
            This code should be at the very top of every script that takes user inputs for signups, logins, and password
            reset requests.
        </p>
    </div>
    ...
    <a class="inline-flex items-center rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring active:text-indigo-500"
        href="https://docs.devrift.co/prevention/breach">
        <span class="text-sm font-medium"> Next: Attack Prevention | Data Breach Prevention </span>
